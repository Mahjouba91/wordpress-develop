...
class WP_Filesystem_FTPext extends WP_Filesystem_Base {
	...
	/**
	 * WP_Filesystem_FTPext constructor.
	 *
	 ...
	 *
	 * @return string|false File contents on success, false if no temp file
	 *     could be opened, or if the file couldn't be retrieved.
	 */
	...
	/**
	 *
	 * @var static bool|null $is_windows
	 *
	 * @param string $line
	 *
	 * @return array|string
